...
class EventController extends Controller
{
    ...
    {
        $events = Event::with('organizer', 'eventCategory')->paginate(10);
    ...
    public function store(Request $request)
    {
        try {
            ...
            return redirect()->route('master_events.index')->with('success', 'Event created successfully.'); 
    ...
    public function update(Request $request, Event $event)
    {
        try {
            ...
            return redirect()->route('master_events.index')->with('success', 'Event updated successfully.'); 
    ...
    public function destroy(Event $event)
    {
        try {
            ...
            return redirect()->route('master_events.index')->with('success', 'Event deleted successfully.'); 
